...
```shell
$ java -jar dist/TESLauncher-0.13.3.jar
```
...
Example:
```shell
$ java -jar dist/TESLauncher-0.13.3.jar --workDir C:\Users\User\Documents\TESLauncher
```
...
Example:
```shell
$ java -jar dist/TESLauncher-0.13.3.jar --useJarLocation
```
