...
```shell
$ java -jar dist/TESLauncher-0.13.2.jar
```
...
Example:
```shell
$ java -jar dist/TESLauncher-0.13.2.jar --workDir C:\Users\User\Documents\TESLauncher
```
...
Example:
```shell
$ java -jar dist/TESLauncher-0.13.2.jar --useJarLocation
```
